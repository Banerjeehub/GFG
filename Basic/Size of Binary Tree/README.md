<h2><a href="https://practice.geeksforgeeks.org/problems/size-of-binary-tree/1?page=2&status[]=unsolved&category[]=Tree&sortBy=submissions">Size of Binary Tree</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary tree of size <strong>N</strong>, you have to count number of nodes in it. For example, count of nodes in below tree is 4.</span></p>
